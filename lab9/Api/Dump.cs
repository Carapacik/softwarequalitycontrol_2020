namespace Api
{
    public class Dump
    {
        ...
        private static readonly JsonProduct[] allProducts =
        {
            new JsonProduct
            {
                id = 1,
        ...
        {
            if (products.Length != allProducts.Length) return false;
